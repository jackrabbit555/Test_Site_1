...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Cart.Cart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Cart.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Products.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Products.ProductFeatures", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Products.ProductImages", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2024, 10, 28, 10, 22, 48, 974, DateTimeKind.Local).AddTicks(2976),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2024, 10, 28, 10, 22, 48, 974, DateTimeKind.Local).AddTicks(3033),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2024, 10, 28, 10, 22, 48, 974, DateTimeKind.Local).AddTicks(3052),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("Test_Site_1.Domain.Entities.Products.Product", b =>
                {
                    b.HasOne("Test_Site_1.Domain.Entities.Products.Category", "Category")
                        .WithMany()
